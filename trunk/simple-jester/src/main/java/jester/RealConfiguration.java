...
public class RealConfiguration implements Configuration {
	...
	public RealConfiguration(String configFileName, PrintStream errorStream) 
      throws IOException {
		...
		if (configPropertyFile != null) {
			...
			errorStream.println("Warning - could not find " + DEFAULT_CONFIGURATION_FILENAME
                    +" so using default configuration values.");
		}
	}
