...
public class ConfigurationTest extends TestCase {
	...
	public void testDefaults() throws IOException {
		Configuration config = new RealConfiguration("there must be no file called this", NullErrorStream); //there is no file called "there must be no file called this"
