...
public class ReportItem {
    ...
    public ReportItem(String sourceFileName, IgnoreListDocument originalContents, int indexOfChange, 
      String valueChangedFrom, String valueChangedTo) {
    ...
    public String toString() {
        ...
        result.append(sourceFileName + " - changed source on line " + lineNumber() 
          + " (char index=" + indexOfChange + ") from " + valueChangedFrom + " to " + valueChangedTo + "\n");
